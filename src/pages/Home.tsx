                    ...
                    {categories.map(cat => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-4 py-1.5 rounded-full text-[0.78rem] font-semibold tracking-[0.04em] border transition-all duration-200 ${isActive ? 'text-white border-transparent' : 'bg-white border-gray-200 text-gray-600 hover:border-gray-400'
                                    }`}
