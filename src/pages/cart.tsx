                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10 items-start">
                                ...
                                <div className="flex-1 flex flex-col justify-between">
                                    ...
                                    <div className="flex justify-between items-center flex-wrap gap-3 mt-3">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <button onClick={() => removeFromCart(item.product.id, item.size, item.color)} className="bg-[#0a0a0a] text-black px-4 py-2 rounded-lg font-medium text-[0.72rem] uppercase tracking-wider hover:text-red transition-all duration-200 shadow-sm">
                                                Remove
                                            </button>
                                        </div>
                                    </div>
                    ...
                    >
                        ...
                        <button
                            ...
                            style={{ background: 'linear-gradient(135deg, #000000ff, #020100ff)' }}
                        >
                            Proceed to Checkout
                        </button>
